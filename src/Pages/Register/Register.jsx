        ...
        <div className="grid justify-center mt-9">
            ...
            <div className="relative flex w-96 flex-col h-full align-middle rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                ...
                <div className="flex flex-col gap-4 p-6">
                    ...
                    <div className=" flex  justify-center p-5 border border-blue-300 shadow shadow-md">
                        <button className='text-3xl hover:bg-gray-300 p-3 rounded-full'>      <FcGoogle></FcGoogle> </button>
